...
abstract class BankMethods{
    abstract public int getAccNo();
    abstract public String getName();
    abstract public String getPassword();
    abstract public double getBalance();
}
class Account extends BankMethods{ /*Use of private access modifiers to implement Encapsulation [provide data security] */
    private int AccNo;
...
public class bank{
        ...
        do{
            ...
            switch(c){
                ...
                case 2 :
                    ...
                    no=in.nextInt();
                    char[] pass = con.readPassword("Set the Password: ");
                    p=new String(pass);
                ...
                case 3 :
                    ...
                    System.out.print("Enter your Account Number :");
                    no=in.nextInt();
                    char[] pass1 = con.readPassword("Set the Password: ");
                    p=new String(pass1);
                    if(no<accno && p.equals(arr[no].getPassword()))
                ...
                case 4 :
                    System.out.print("Enter your Account Number :");
                    no=in.nextInt();
                    char[] pass3 = con.readPassword("Set the Password: ");
                    p=new String(pass3);
                    if(no<accno && p.equals(arr[no].getPassword()))
    ...
    private static void checkMaster(FixedDeposit arr[])throws IOException{
        char[] pass = con.readPassword("Enter the admin password: ");
